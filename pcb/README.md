...
| Part | Qty | Note |
|---|---|---|
| Screw terminal block 2P, **5.0mm pitch** | 1 | 5.08mm 2P also fits (offset within slack) |
| Screw terminal block 4P, **5.0mm pitch (KF126/DG126/MX126 type)** | 1 | **A 5.08mm 4P does NOT drop in** (outer pins miss by 0.12mm vs ~0.06mm hole slack). Alternatively use 2x 2P blocks |
